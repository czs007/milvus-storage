...
unsafe extern "C" {
    ...
    pub static loon_errcode_storage_not_found: i32;
    pub static loon_errcode_storage_access_denied: i32;
    pub static loon_errcode_storage_precondition_failed: i32;
...
pub(crate) fn classified_vortex_error(
    ...
    into_vortex_error(LoonFFIError {
        err_code,
