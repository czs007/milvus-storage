...
use crate::filesystem_c::{
    ...
    loon_errcode_storage_access_denied, loon_errcode_storage_not_found,
    loon_errcode_storage_precondition_failed, loon_errcode_file_not_found, loon_errcode_not_support, loon_errcode_transient_throttling,
...
fn into_object_store_error(error: LoonFFIError, path: &ObjectPath) -> object_store::Error {
    ...
    if code == unsafe { loon_errcode_storage_access_denied }
    {
    ...
    if code == unsafe { loon_errcode_storage_precondition_failed } {
